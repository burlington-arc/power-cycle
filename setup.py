...
See:
https://github.com/trasukg/power-cycle.git
"""
...
setup(
    ...
    url='https://github.com/trasukg/power-cycle.git',

    # Author details
    author='Greg Trasuk VA3TSK',
    author_email='trasukg@trasuk.com',
    ...
    classifiers=[
        ...
        'Intended Audience :: Repeater Admins',
